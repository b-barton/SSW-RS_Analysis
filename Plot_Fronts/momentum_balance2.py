...
def viscosity_friction(ah, u, v, x, y, trio):
...
fn_dy = sorted(glob.glob(mjas + 'Model_Output_V3.02/Hourly/1998/SSWRS_V3.02*hr*RE.nc'))
...
FVCOM = readFVCOM(fn_dy[-1], vars, dims=dims)
...
fig3.savefig('./Figures/my_balance.png')
