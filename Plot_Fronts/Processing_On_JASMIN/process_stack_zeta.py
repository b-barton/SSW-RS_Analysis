...
zeta = np.ma.zeros((len(fn) * 10, lon.shape[0])) - 999
...
np.savez(out_dir + 'stack_zeta.npz', zeta=zeta, date_list=date_list, lon=lon, lat=lat, tri=triangles)
