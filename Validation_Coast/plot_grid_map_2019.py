...
axc1.set_ylabel('Obs. Salinity')
cb2 = fig2.colorbar(CS2, axc2, extend='both')
axc2.set_ylabel('Salinity Difference')
...
fig1.savefig('./Figures/all_grid_tmap_2019.png')
fig2.savefig('./Figures/all_grid_smap_2019.png')
