...
axc2 = fig1.add_axes([0.91, 0.3, 0.02, 0.4])
...
axc2 = fig2.add_axes([0.91, 0.3, 0.02, 0.4])
...
fig1.savefig('./Figures/all_profiles_tmap.png')
fig2.savefig('./Figures/all_profiles_smap.png')
