...
if 1:
  ...
  ax1.set_title('Nov-Apr (Winter)')
  ax2.set_title('Nov-Apr (Winter)')
  ax3.set_title('Nov-Apr (Winter)')
  #ax4.set_title('Winter')
  ax5.set_title('May-Oct (Summer)')
  ax6.set_title('May-Oct (Summer)')
  ax7.set_title('May-Oct (Summer)')
  ...
  cs1 = ax1.scatter(temp_grid[0:2], temp_mgrid[0:2], c=dist_g[0:2], s=2, marker='o', vmin=0, vmax=200)
  ax1.scatter(temp_grid[ind1], temp_mgrid[ind1], c=dist_g[ind1], s=2, marker='o', vmin=0, vmax=200, alpha=al)
  ax2.scatter(temp_grid[ind1], temp_amm7[ind1], c=dist_g[ind1], s=2, marker='o', vmin=0, vmax=200, alpha=al)
  ax3.scatter(sal_grid[ind1], sal_mgrid[ind1], c=dist_g[ind1], s=2, marker='o', vmin=0, vmax=200, alpha=al)
  ax4.scatter(sal_grid[ind1], sal_amm7[ind1], c=dist_g[ind1], s=2, marker='o', vmin=0, vmax=200, alpha=al)

  ax5.scatter(temp_grid[ind2], temp_mgrid[ind2], c=dist_g[ind2], s=2, marker='o', vmin=0, vmax=200, alpha=al)
  ax6.scatter(temp_grid[ind2], temp_amm7[ind2], c=dist_g[ind2], s=2, marker='o', vmin=0, vmax=200, alpha=al)
  ax7.scatter(sal_grid[ind2], sal_mgrid[ind2], c=dist_g[ind2], s=2, marker='o', vmin=0, vmax=200, alpha=al)
  ax8.scatter(sal_grid[ind2], sal_amm7[ind2], c=dist_g[ind2], s=2, marker='o', vmin=0, vmax=200, alpha=al)
  ...
  ax1.annotate('(a) Nov-Apr (Winter)', (0.05, 0.92), xycoords='axes fraction', bbox=dict(boxstyle="round", fc="w"), zorder=105)
  ax2.annotate('(b) Nov-Apr (Winter)', (0.05, 0.92), xycoords='axes fraction', bbox=dict(boxstyle="round", fc="w"), zorder=105)
  ax3.annotate('(c) Nov-Apr (Winter)', (0.05, 0.92), xycoords='axes fraction', bbox=dict(boxstyle="round", fc="w"), zorder=105)
  ax4.annotate('(d) Nov-Apr (Winter)', (0.05, 0.92), xycoords='axes fraction', bbox=dict(boxstyle="round", fc="w"), zorder=105)

  ax5.annotate('(e) May-Oct (Summer)', (0.05, 0.92), xycoords='axes fraction', bbox=dict(boxstyle="round", fc="w"), zorder=105)
  ax6.annotate('(f) May-Oct (Summer)', (0.05, 0.92), xycoords='axes fraction', bbox=dict(boxstyle="round", fc="w"), zorder=105)
  ax7.annotate('(g) May-Oct (Summer)', (0.05, 0.92), xycoords='axes fraction', bbox=dict(boxstyle="round", fc="w"), zorder=105)
  ax8.annotate('(h) May-Oct (Summer)', (0.05, 0.92), xycoords='axes fraction', bbox=dict(boxstyle="round", fc="w"), zorder=105)
...
if do_vs == False:
  fig2.savefig('./Figures/all_grid_dist_ts.png')
else:
  fig3.savefig('./Figures/all_grid_dist_vs.png')
